  ...
  render() {
    return (
      <div className="Home" align="center">
        ...
        <h2>
          Share Yourself Artists is the easiest way to share your artwork to
          millions of art lovers AROUND THE WORLD!
        </h2>
        <img src="https://i.imgur.com/y6Bn06P.png" alt="banner" width="100%" />
